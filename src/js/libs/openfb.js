...
var openFB = (function () {
    ...
    var FB_LOGIN_URL = 'https://accounts.spotify.com/authorize/',
        response_type = 'token',
    ...
    function login(scope, success, error) {
        ...
        loginWindow = window.open(FB_LOGIN_URL + '?response_type=token&client_id=829a1ca939014906b618305f7c5ad1c5&redirect_uri=https://www.facebook.com/connect/login_success.html&scope=user-read-private%20playlist-read%20playlist-read-private', '_blank', 'location=yes')
